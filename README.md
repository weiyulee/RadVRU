...
* The RAD radar cubes saved in a binary file. 
* The meta data that specifies the range, azimuth, and velocity bins.
* The camera data compressed in MJPEG format;
* Vision feed-forward array generated by using detections from [YOLOv8](https://github.com/ultralytics/ultralytics).
